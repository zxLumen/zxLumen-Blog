...
- **访客统计(悬浮)**:首页**右上角固定悬浮按钮**(如「PV 12 · 在线 2」),点击展开浮层,
  显示 总 PV/UV、今日 PV/UV、在线、近 30 天 PV 趋势。**公开可见**,功能门控 `visitor-stats`。
- **项目点击**:每个**项目卡**上常驻显示「▸ N 次」(点击次数)。
- **admin「统计」Tab**:`/admin` → 统计,展示 **留言**(总/今日/公开/仅站长可见/留言者)、
  **简历下载**、**项目点击**(全部 + 按次数排序)、**访客**(PV/UV/今日/在线)。仅站长可见。
